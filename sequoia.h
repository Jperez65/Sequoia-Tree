...
public:
  ...
  void updateheight(SequoiaNode* cur);
  void updateheightRemoval(SequoiaNode* cur);
  void verifyHeight(SequoiaNode* cur);
  void fixBalanceInsert(SequoiaNode* pivot, bool flag);
  void fixBalanceRemove(SequoiaNode* pivot, bool flag);
  void rotateleft();
  void rotateright();
};
